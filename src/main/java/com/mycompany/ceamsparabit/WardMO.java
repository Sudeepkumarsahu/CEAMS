...
public class WardMO extends javax.swing.JFrame {
    ...
    public WardMO() {
        initComponents();
         JComponent[] components = {jButton1,jButton2,jButton3,jButton4,jButton5,jButton6};
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Latest notification");

        jLabel2.setText("Latest comment");

        jButton1.setText("Land Inspector Updates");

        jButton2.setText("Registered land");

        jButton3.setText("Official Notification");

        jButton4.setText("Comment");

        jButton5.setText("Activity");
